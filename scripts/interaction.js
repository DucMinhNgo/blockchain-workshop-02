...
async function interact() {
    ...
    /// Call
    myBalance = await floppyContract.methods.balanceOf(sendAddress).call();
    ...
    // rs = await floppyContract.methods.transfer(receiverAddress, 200000).send({
    //     from: sendAddress,
    //     gas: 300000, // max gas
    // });
    rs = await floppyContract.methods.transfer(receiverAddress, 200000).send({
